...
description: "Jäsentää päätöksen rakentaa itse, ostaa alustalta vai kumppanoitua AI-ratkaisussa. Käytä kun tarvitset ai strategy & governance-tason tukea vastaavaan tehtävään."
---
...
Jäsentää päätöksen rakentaa itse, ostaa alustalta vai kumppanoitua AI-ratkaisussa.
...
- Ei tee hankintapäätöstä tai kilpailuta toimittajia — jäsentää päätöskriteerit.
...
- Samassa pakissa seuraavaksi: `../ai-capability-roadmap/SKILL.md` — Rakentaa organisaation AI-kyvykkyyskartan ja roadmapin nykytilasta tavoitetilaan.
