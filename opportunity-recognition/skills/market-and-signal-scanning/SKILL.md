...
description: "Systemaattinen ympäristön skannaus (markkina, teknologia, sääntely, kilpailu) mahdollisuuksien tunnistamiseksi. Käytä kun tarvitset opportunity recognition-tason tukea vastaavaan tehtävään."
---
...
Systemaattinen ympäristön skannaus (markkina, teknologia, sääntely, kilpailu) mahdollisuuksien tunnistamiseksi.
...
- Ei tee automaattista markkinatutkimusta reaaliaikaisella datalla — jäsentää mistä ja miten skannataan.
...
- Samassa pakissa seuraavaksi: `../pattern-and-analogy-connector/SKILL.md` — Yhdistää irrallisia havaintoja mielekkääksi mahdollisuudeksi tunnistamalla analogioita eri toimialojen/tilanteiden välillä.
