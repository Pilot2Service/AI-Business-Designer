...
description: "Kartoittaa sidosryhmät valta/intressi-matriisilla ja määrittää vastuut RACI:lla. Käytä kun tarvitset business case & analysis-tason tukea vastaavaan tehtävään."
---
...
Kartoittaa sidosryhmät valta/intressi-matriisilla ja määrittää vastuut RACI:lla.
...
- Ei tunnista sidosryhmiä puolestasi ilman että kerrot organisaation todelliset toimijat.
...
- Samassa pakissa seuraavaksi: `../assumption-and-evidence-audit/SKILL.md` — Testaa oletukset ja tunnistaa evidenssiaukot ennen suosituksen lukitsemista.
